...
#[test]
fn test_format_envelope() -> Result<(), Box<dyn std::error::Error>> {
    let output = run_cli(&["format", ENVELOPE], None)?;
    assert_eq!(
        output,
        indoc! {r#"
        {
...
#[test]
fn test_format_cbor() -> Result<(), Box<dyn std::error::Error>> {
    let output: String = run_cli(&["format", "--type", "cbor", ENVELOPE], None)?;
    assert_eq!(
        output,
        indoc! {r#"
        
        "#}
    );
    Ok(())
}
...
#[test]
fn test_format_diag() -> Result<(), Box<dyn std::error::Error>> {
    let output: String = run_cli(&["format", "--type", "diag", ENVELOPE], None)?;
    assert_eq!(
        output,
        indoc! {r#"
        200(   / envelope /
...
#[test]
fn test_format_tree() -> Result<(), Box<dyn std::error::Error>> {
    let output: String = run_cli(&["format", "--type", "tree", ENVELOPE], None)?;
    assert_eq!(
        output,
        indoc! {r#"
        7da760aa NODE
